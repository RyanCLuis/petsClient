...
// the action will be dependent upon parent component(update and create)
// but the form itself will be the same for both
import { Form, Button, Container } from 'react-bootstrap'

const PetForm = (props) => {
    // we need several specific props to make this form reusable
    // we need the object itself (apet), a handleChange, and a handleSubmit
    // those function will be determined by the parent component and passed to the parent component
